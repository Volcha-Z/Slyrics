...
import (
	...
	"slyrics/player"
	"slyrics/services/browser"
	"slyrics/services/mopidy"
	"slyrics/services/mpd"
	"slyrics/services/mpris"
	"slyrics/services/spotify"
...
type Config struct {
	...
	Style struct {
		...
		Uppercase   bool   `default:"false" yaml:"uppercase"`
		OnlyCurrent bool   `default:"true" yaml:"onlyCurrent"`
		BlockFont   bool   `default:"true" yaml:"blockFont"`
		Effect3D    bool   `default:"false" yaml:"effect3D"`
